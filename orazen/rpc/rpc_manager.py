...
from orazen.enums import NO_ECHO_MESSAGES, RPCMessageType
from orazen.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, orazen) -> None:
        ...
        self._rpc = RPC(orazen)
        config = orazen.config
        # Enable telegram
        if config.get("telegram", {}).get("enabled", False):
            logger.info("Enabling rpc.telegram ...")
            from orazen.rpc.telegram import Telegram
