...
from orazen.enums import BacktestState, RunMode
from orazen.exceptions import ConfigurationError, DependencyException, OperationalException
from orazen.ft_types import get_BacktestResultType_default
from orazen.misc import deep_merge_dicts, is_file_in_dir
from orazen.rpc.api_server.api_schemas import (
...
from orazen.rpc.api_server.deps import get_config, verify_strategy
...
def __run_backtest_bg(btconfig: Config, job_id: str):
    ...
    from orazen.optimize.optimize_reports import generate_backtest_stats, store_backtest_results
...
def api_get_backtest():
    ...
    """
    from orazen.persistence import LocalTrade
