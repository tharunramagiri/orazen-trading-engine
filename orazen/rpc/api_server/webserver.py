...
from orazen.configuration import running_in_docker
...
from orazen.rpc.api_server.ws.message_stream import MessageStream
from orazen.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def configure_app(self, app: FastAPI, config):
        from orazen.rpc.api_server.api_analysis import router_lookahead, router_recursive
        from orazen.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from orazen.rpc.api_server.api_background_tasks import router as api_bg_tasks
        from orazen.rpc.api_server.api_backtest import router as api_backtest
        from orazen.rpc.api_server.api_download_data import router as api_download_data
        from orazen.rpc.api_server.api_pair_history import router as api_pair_history
        from orazen.rpc.api_server.api_pairlists import router as api_pairlists
        from orazen.rpc.api_server.api_trading import router as api_trading
        from orazen.rpc.api_server.api_v1 import router as api_v1
        from orazen.rpc.api_server.api_v1 import router_public as api_v1_public
        from orazen.rpc.api_server.api_webserver import router as api_webserver
        from orazen.rpc.api_server.api_ws import router as ws_router
        from orazen.rpc.api_server.deps import is_trading_mode, is_webserver_mode
        from orazen.rpc.api_server.web_ui import router_ui
