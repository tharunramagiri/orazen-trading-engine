...
from orazen.persistence import FtNoDBContext
from orazen.rpc.api_server.api_pairlists import handleExchangePayload
from orazen.rpc.api_server.api_schemas import BgJobStarted, DownloadDataPayload
from orazen.rpc.api_server.deps import get_config, get_exchange
...
def __run_download(job_id: str, config_loc: Config):
    try:
        ...
        from orazen.data.history.history_utils import download_data
