...
from orazen.strategy import IntParameter, IStrategy, merge_informative_pair  # noqa
...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    FreqAI to bolster a typical Orazen strategy.

    Launching this strategy would be:

    orazen trade --strategy FreqaiExampleHybridStrategy --strategy-path orazen/templates
