...
from orazen.configuration.load_config import CONFIG_PARSE_MODE
from orazen.exceptions import OperationalException
from orazen.exchange.exchange_types import Tickers
from orazen.plugins.pairlist.IPairList import IPairList, PairlistParameter, SupportsBacktesting
...
class RemotePairList(IPairList):
    ...
    def fetch_pairlist(self) -> tuple[list[str], float]:
        headers = {"User-Agent": "Orazen/" + __version__ + " Remotepairlist"}
