...
from orazen.misc import round_dict
...
class IHyperOpt(ABC):
    ...
    def roi_space(self) -> list[Dimension]:
        ...
        It's used by Orazen by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy Orazen roi_space()
