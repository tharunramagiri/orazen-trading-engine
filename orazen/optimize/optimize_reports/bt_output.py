...
from orazen.constants import UNLIMITED_STAKE_AMOUNT, Config
from orazen.ft_types import BacktestResultType
from orazen.optimize.optimize_reports.optimize_reports import generate_periodic_breakdown_stats
from orazen.util import decimals_per_coin, fmt_coin, print_rich_table
...
def text_table_add_metrics(strat_results: dict) -> None:
    ...
    if len(strat_results["trades"]) > 0:
        ...
        # command stores these results and newer version of orazen must be able to handle old
