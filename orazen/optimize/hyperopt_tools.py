...
from orazen.constants import FTHYPT_FILEVERSION, HYPEROPT_BUILTIN_SPACES, Config
from orazen.enums import HyperoptState
from orazen.exceptions import OperationalException
from orazen.misc import deep_merge_dicts, round_dict, safe_value_fallback2
from orazen.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get("is_best") is None:
                raise OperationalException(
                    ...
                    "of Orazen and cannot be loaded."
                )
