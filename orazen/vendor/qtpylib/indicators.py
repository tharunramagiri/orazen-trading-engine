# orazen previously vendored a copy of qtpylib's indicators
...
# `from orazen.vendor.qtpylib.indicators import crossed_above` keep working,
...
warnings.warn(
    "'orazen.vendor.qtpylib.indicators' is deprecated and will be removed in a future "
