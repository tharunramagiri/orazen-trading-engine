    ...
    "properties": {
        ...
        "telegram": {
            ...
            "properties": {
                ...
                "chat_id": {
                    "description": (
                        f"Telegram chat or group ID. {__VIA_ENV} ORAZEN__TELEGRAM__CHAT_ID"
                    ),
                    "type": "string",
                },
                "topic_id": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ORAZEN__TELEGRAM__TOPIC_ID"
                    ),
                    "type": "string",
                },
                "authorized_users": {
        ...
        "webhook": {
            ...
            "properties": {
                ...
                "url": {
                    "description": f"Webhook URL. {__VIA_ENV} ORAZEN__WEBHOOK__URL",
                    "type": "string",
                },
        ...
        "discord": {
            ...
            "properties": {
                ...
                "webhook_url": {
                    "description": (
                        f"Discord webhook URL. {__VIA_ENV} ORAZEN__DISCORD__WEBHOOK_URL"
                    ),
                    "type": "string",
                },
                "exit_fill": {
    ...
    "definitions": {
        "exchange": {
            ...
            "properties": {
                ...
                "api_key": {
                    "description": (
                        f"API key for the exchange. {__VIA_ENV} ORAZEN__EXCHANGE__API_KEY"
                    ),
                    "type": ["string", "null"],
                },
                "key": {
                    "description": (
                        f"API key for the exchange. {__VIA_ENV} ORAZEN__EXCHANGE__KEY"
                ...
                "secret": {
                    "description": (
                        f"API secret for the exchange. {__VIA_ENV} ORAZEN__EXCHANGE__SECRET"
                    ),
                    "type": ["string", "null"],
                    "default": None,
                },
                "password": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ORAZEN__EXCHANGE__PASSWORD"
                    ),
                    "type": ["string", "null"],
                    "default": None,
                },
                "uid": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ORAZEN__EXCHANGE__UID"
                    ),
                    "type": ["string", "null"],
                },
                "account_id": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ORAZEN__EXCHANGE__ACCOUNT_ID"
                    ),
                    "type": ["string", "null"],
                },
                "wallet_address": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ORAZEN__EXCHANGE__WALLET_ADDRESS"
                    ),
                    "type": ["string", "null"],
                },
                "private_key": {
                    "description": (
                        ...
                        f"{__VIA_ENV} ORAZEN__EXCHANGE__PRIVATE_KEY"
                    ),
                    "type": ["string", "null"],
                },
                "pair_whitelist": {
