...
from orazen.configuration.deprecated_settings import process_temporary_deprecated_settings
from orazen.configuration.directory_operations import create_datadir, create_userdata_dir
from orazen.configuration.environment_vars import environment_vars_to_dict
from orazen.configuration.load_config import load_file, load_from_files
...
from orazen.misc import deep_merge_dicts, parse_db_uri_for_logging, safe_value_fallback
...
class Configuration:
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        from orazen.commands.arguments import NO_CONF_ALLOWED
