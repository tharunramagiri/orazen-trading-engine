...
import orazen.exchange as exchanges
from orazen.constants import Config, ExchangeConfig
from orazen.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in orazen.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("orazen.", ""),
                    }
                )
        return result
