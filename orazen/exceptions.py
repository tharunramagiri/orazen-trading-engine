class OrazenException(Exception):
    """
    Orazen base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(OrazenException):
    """
...
class DependencyException(OrazenException):
    """
...
class StrategyError(OrazenException):
    """
