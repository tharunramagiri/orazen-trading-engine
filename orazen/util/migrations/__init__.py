...
from orazen.util.migrations.funding_rate_mig import migrate_funding_fee_timeframe
from orazen.util.migrations.migrate_wallet_history import migrate_wallet_history
