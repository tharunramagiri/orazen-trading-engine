...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from orazen.util import fmt_coin, get_dry_run_wallet
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting orazen in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from orazen.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting orazen in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of orazen Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help orazen to exit
...
def start_recursive_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from orazen.configuration import setup_utils_configuration
    from orazen.optimize.analysis.recursive_helpers import RecursiveAnalysisSubFunctions
