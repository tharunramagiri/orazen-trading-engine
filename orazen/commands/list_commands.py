...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    from orazen.exchange import list_available_exchanges
    from orazen.ft_types import ValidExchangesType
    from orazen.loggers.rich_console import get_rich_console
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            title = f"Exchanges available for Orazen ({len(available_exchanges)} exchanges):"
...
def start_list_hyperopt_loss_functions(args: dict[str, Any]) -> None:
    ...
    """
    from orazen.configuration import setup_utils_configuration
    from orazen.resolvers.hyperopt_resolver import HyperOptLossResolver
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from orazen.configuration import setup_utils_configuration
    from orazen.exchange import market_is_active
    from orazen.misc import plural, safe_value_fallback
    from orazen.resolvers import ExchangeResolver
    from orazen.util import print_rich_table
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from orazen.configuration import setup_utils_configuration
    from orazen.misc import parse_db_uri_for_logging
