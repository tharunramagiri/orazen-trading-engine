...
from orazen.constants import USERPATH_STRATEGIES
...
def start_create_userdir(args: dict[str, Any]) -> None:
    ...
    :return: None
    """
    from orazen.configuration.directory_operations import copy_sample_files, create_userdata_dir
...
def deploy_new_strategy(strategy_name: str, strategy_path: Path, subtemplate: str) -> None:
    ...
    """
    from orazen.util import render_template, render_template_with_fallback
