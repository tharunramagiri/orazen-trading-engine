...
from orazen.commands.cli_options import AVAILABLE_CLI_OPTIONS
from orazen.constants import DEFAULT_CONFIG
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = ArgumentParser(
            prog="orazen", description="Free, open source crypto trading bot"
        )
        ...
        edge_cmd = subparsers.add_parser(
            "edge",
            # help="Edge module. No longer part of Orazen",
