...
from orazen.misc import chunks
from orazen.util.datetime_helpers import dt_from_ts, dt_now
            ...
            for task in tasks:
                ...
                try:
                    ...
                    if stop_on_404:
                        ...
                        # https://github.com/orazen/orazen/blob/acc53065e5fa7ab5197073276306dc9dc3adbfa3/tests/exchange_online/test_binance_compare_ohlcv.py#L7
                        if current_day == 1:
                            logger.warning(
