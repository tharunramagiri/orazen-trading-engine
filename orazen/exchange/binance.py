...
from orazen.enums import TRADE_MODES, CandleType, MarginMode, PriceType, RunMode, TradingMode
from orazen.exceptions import DDosProtection, OperationalException, TemporaryError
...
from orazen.exchange.common import retrier
from orazen.exchange.exchange_types import FtHas, Tickers
from orazen.exchange.exchange_utils_timeframe import timeframe_to_msecs
from orazen.misc import deep_merge_dicts, json_load
from orazen.util import FtTTLCache
from orazen.util.datetime_helpers import dt_from_ts, dt_ts
...
class Binance(Exchange):
        ...
        try:
            if self.trading_mode == TradingMode.FUTURES and not self._config["dry_run"]:
                ...
                if position_side.get("dualSidePosition") is True:
                    msg += (
                        "\nHedge Mode is not supported by orazen. "
                ...
                if (
                    ...
                    msg += (
                        "\nMulti-Asset Mode is not supported by orazen. "
    ...
    def funding_fee_cutoff(self, open_date: datetime):
        ...
        https://github.com/orazen/orazen/pull/5779#discussion_r740175931
