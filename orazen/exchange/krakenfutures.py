...
from orazen.enums import MarginMode, PriceType, TradingMode
...
from orazen.exchange.common import API_FETCH_ORDER_RETRY_COUNT, retrier
from orazen.exchange.exchange import Exchange
from orazen.exchange.exchange_types import CcxtBalances, CcxtOrder, FtHas
from orazen.misc import safe_value_nested
from orazen.util.datetime_helpers import dt_from_ts
...
class Krakenfutures(Exchange):
    ...
    def get_trades_for_order(
        ...
        using the market's fee schedule so Orazen's fee detection works.
        """
