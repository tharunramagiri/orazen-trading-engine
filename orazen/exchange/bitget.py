...
from orazen.enums import OPTIMIZE_MODES, CandleType, MarginMode, PriceType, TradingMode
...
from orazen.exchange.common import API_RETRY_COUNT, retrier
from orazen.exchange.exchange_types import CcxtOrder, FtHas
from orazen.util import dt_from_ts, dt_now, dt_ts
    ...
    def dry_run_liquidation_price(
        ...
        if self.trading_mode == TradingMode.FUTURES and self.margin_mode == MarginMode.ISOLATED:
            ...
            raise OperationalException(
                "Orazen currently only supports isolated futures for bitget"
            )
