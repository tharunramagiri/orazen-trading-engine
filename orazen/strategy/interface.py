...
from orazen.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
from orazen.data.converter import populate_dataframe_with_trades
from orazen.data.converter.converter import reduce_dataframe_footprint
...
from orazen.exceptions import OperationalException, StrategyError
from orazen.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from orazen.ft_types import AnnotationType
from orazen.misc import remove_entry_exit_signals
from orazen.persistence import Order, PairLocks, Trade
from orazen.strategy.hyper import HyperStrategyMixin
from orazen.strategy.informative_decorator import (
    InformativeCache,
    InformativeData,
    PopulateIndicators,
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for orazen strategies
    ...
    def load_freqAI_model(self) -> None:
        if self.config.get("freqai", {}).get("enabled", False):
            ...
            from orazen.freqai.utils import download_all_data_for_training
            from orazen.resolvers.freqaimodel_resolver import FreqaiModelResolver
    ...
    def feature_engineering_expand_all(
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://www.orazen.io/en/stable/freqai-parameter-table/#feature-parameters

        https://www.orazen.io/en/stable/freqai-feature-engineering/#defining-the-features
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by orazen itself, but intended to be used if users lock pairs
    ...
    def ft_plot_annotations(self, pair: str, dataframe: DataFrame) -> list[AnnotationType]:
        ...
        if len(dataframe) > 0:
            ...
            from orazen.ft_types.plot_annotation_type import AnnotationTypeTA
