...
A position orazen enters is stored in a `Trade` object - which is persisted to the database.
It's a core concept of orazen - and something you'll come across in many sections of the documentation, which will most likely point you to this location.
